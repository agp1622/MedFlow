        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Doctors_UserId", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryCondition = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_DoctorId_Status",
                table: "Invoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalNotes_PatientId_DoctorId",
                table: "MedicalNotes",
                columns: new[] { "PatientId", "DoctorId" });

            migrationBuilder.CreateIndex(
                name: "IX_Patients_DoctorId_Status",
                table: "Patients",
                columns: new[] { "DoctorId", "Status" });
